...
def notification_handler(sender, instance, created, **kwargs):
    # call group_send function directly to send notifications pr you can create dynamic task in celery beat
    if created:
        ...
        task = PeriodicTask.objects.create(crontab=schedule, name="broadcast_notification_" + str(instance.id),
